...
import laboratorium.lista3.object.ArrayStack;
import laboratorium.lista3.object.LinkedQueue;
...
public class TrollTest
{
	...
	public static void trollTestGenericStack()
	{
		...
		stack.push(6);
		System.out.println(stack.toString());
		// System.out.println("Pushed: " + 5 + "|Size: " + stack.size() + "|Top:
		// " + stack.getTop());
		// System.out.println("Zdjêto: " + stack.pop() + "|Size: " +
		// stack.size() + "|Top: " + stack.getTop());
		// System.out.println("Zdjêto: " + stack.pop() + "|Size: " +
		// stack.size() + "|Top: " + stack.getTop());
		// System.out.println("Zdjêto: " + stack.pop() + "|Size: " +
		// stack.size() + "|Top: " + stack.getTop());
